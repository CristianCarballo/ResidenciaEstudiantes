                        ...
                        <div class="col-md-8 text-center" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <center style="width: 800px;">
                                <div class="container-fluid">
                                    <h1 class="mt-4">
                                        Lista de Recaudación por Inquilino
                                    </h1>
                                </div>


                            <c:choose>
                                <c:when test="${empty listaRecaudacionInquilino}">
                                ...
                                <c:otherwise>
                                    ...
                                    <table class="table text-primary bg-dark table-wrapper-scroll-y my-custom-scrollbar">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listaRecaudacionInquilino}" var="inquilino">
                                                <tr>
                                                    <th scope="row">${inquilino.idInquilino}</th>
                                                    <td>${inquilino.nombreInquilino}</td>
                                                    <td>${inquilino.apellidoInquilino}</td> 
                                                    <td>$ ${inquilino.recaudacionInquilino}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
